...
class TestCalculate:
    ...
    def test_get_largest_sum_of_1_adjacent_digit_within_a_multiple_digit_number_is_expected_value(self):
        value = get_largest_sum_of_adjacent_digits(121, num_adjacent_digits=1)
        assert value == 2, "got {}".format(value)

    def test_get_largest_sum_of_multiple_adjacent_digits_within_multiple_digit_number_is_expected_value(self):
